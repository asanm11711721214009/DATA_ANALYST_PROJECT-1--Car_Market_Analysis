🚗 Car Market Analysis – Data Analyst Project
...
Queries.Sql/ → SQL scripts for data cleaning, transformation, and analysis.

Power BI Dashboard/ → Interactive dashboard showcasing visual insights.
...
Price Trends → Comparison of car prices across brands and years.

Fuel Type Analysis → Market share of petrol, diesel, and electric vehicles.

Brand Performance → Top-selling brands and their average pricing.
...
Interactive filters for brand, year, and fuel type.

Visual KPIs such as average price, total sales, and market share.
